                ...
                <section class="row navbar-fixed-top">
                    <div class="col-12 col-lg-9">
                        <div class="row">
                            ...
                            <div class="col-6 col-lg-3 col-md-6 card3">
                                <div class="card">
                                    <div class="card-body px-3 py-4-5">
                                        <div class="row">
                                            ...
                                            <div class="col-md-8">
                                                ...
                                                <h6 class="font-extrabold mb-0"><?php echo count($result); ?></h6>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-body shadow-sm">
                                            ...
                                            <img style="width: 70%;" src="assets/images/<?= $row['image'];?>">
                                            <br>
                                            <br>
                                            <a href="deletepost.php?id= <?= $row['id']; ?>"><button type="button" class="btn btn-danger">Delete</button></a>
                                        </div>
                                    </div>
                                </div>
                            </div>

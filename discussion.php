        ...
        <div id="main" style="background-color: #f2f7ff;">
            ...
            <div class="page-heading">
                ...
                <blockquote class="blockquote text-right">
                    <p class="mb-0">Anda dapat memilih forum diskusi sesuai minat anda !</p><br>
                    <div class="blockquote-footer">The aim of argument, or of discussion, should not be victory, but progress. <cite title="Source Title">Joseph Joubert</cite></div>
                </blockquote>
